...
class QuestionByLanguagesControllerTest < ActionController::TestCase
  ...
  test "should create question_by_language" do
    assert_difference('QuestionByLanguage.count') do
      post :create, question_by_language: { created_at: @question_by_language.created_at, language: @question_by_language.language, options: @question_by_language.options, question_id: @question_by_language.question_id, title: @question_by_language.title, updated_at: @question_by_language.updated_at }
    end
  ...
  test "should update question_by_language" do
    patch :update, id: @question_by_language, question_by_language: { created_at: @question_by_language.created_at, language: @question_by_language.language, options: @question_by_language.options, question_id: @question_by_language.question_id, title: @question_by_language.title, updated_at: @question_by_language.updated_at }
    assert_redirected_to question_by_language_path(assigns(:question_by_language))
  end
